...
main = do
    ...
    play janela white fr (estadoInicial (p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14,p15,p16,p17,p18,p19,p20,p21,p22,p23,p24,p25,p26,p27,p28,p29,p30,p31,p32,p33,p34)) draw reage (\_ e -> e)
...
estadoInicial (p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14,p15,p16,p17,p18,p19,p20,p21,p22,p23,p24,p25,p26,p27,p28,p29,p30,p31,p32,p33,p34) =
    E
    (Menu Jogar (p1,p2,p3,p4,p5,p21,p23,p24) False)
    (0, length world, False, world, j1, (p6,p7,p8,p9,p10,p11,p12,p13,p14,p20,p22), False)
...
reage e (E (Menu _ t1 _) (_, _, True, _, _, t2, _) (Pausa _ t3 _) (Nivel _ _ t4)) = E (Menu Jogar t1 False) (0, length world, False, world, j1, t2, False) (Pausa Continuar t3 True) (Nivel 1 False t4)
reage (EventKey (Char 'p') Down _ _) (E em@(Menu Jogar e True) ej (Pausa Continuar t True) en) = E em ej (Pausa Continuar t False) en
reage e (E em@(Menu Jogar _ True) ej ep@(Pausa Continuar _ False) en) = E em ej (reagePausa e ep) en
reage e (E em@(Menu Jogar _ True) ej ep@(Pausa VoltarAoMenu _ False) en) = E em ej (reagePausa e ep) en
reage e (E em@(Menu Jogar t1 True) (n, nMax, v, _, _, t, h) (Pausa VoltarAoMenu t2 True) (Nivel _ _ t3)) = E (reageMenu e (Menu Jogar t1 False)) (0, nMax, False, world, j1, t, h) (Pausa Continuar t2 True) (Nivel 1 False t3)
reage e (E em@(Menu Jogar _ True) ej ep@(Pausa Continuar _ True) en) = E em (reageJogo e ej) ep en
reage e (E em@(Menu Niveis t1 True) (_,_,_,_,_,t2,_) ep en@(Nivel n True _)) = E (Menu Jogar t1 True) (n - 1, n, False, world, world !! (n - 1), t2, False) ep en
reage e (E em@(Menu Niveis _ True) ej ep en) = E em ej ep (reageNiveis e en)
reage e (E em ej ep en) = E (reageMenu e em) ej ep en

draw :: Estado -> Picture
draw (E (Menu _ e _) (_, _, True, _, _, _, _) ep en) = drawMenu (Menu Jogar e False)
...
draw (E (Menu Jogar _ True) ej@(n, nMax, v, j, ja, t, h) ep@(Pausa VoltarAoMenu _ False) en) = drawPausa ep
...
type EstadoJogo = (Int, Int, Bool, [Jogo], Jogo, ElementosJogo, Bool)
