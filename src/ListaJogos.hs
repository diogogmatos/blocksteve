...
j1 :: Jogo
j1 = Jogo [[Vazio,Vazio,Vazio],
           [Porta,Vazio,Vazio],
           [Bloco,Bloco,Bloco]]
          (Jogador (2,1) Este False) 

j2 :: Jogo
j2 = Jogo [[Vazio,Bloco,Vazio,Vazio,Vazio,Vazio,Vazio,Vazio,Vazio,Vazio,Vazio,Vazio,Vazio,Vazio,Vazio,Vazio,Vazio,Vazio,Vazio],
...
j3 :: Jogo
j3 = Jogo [[Vazio,Vazio,Vazio,Vazio,Vazio,Bloco,Bloco,Bloco,Vazio,Vazio,Vazio,Vazio,Bloco,Bloco,Bloco,Bloco,Bloco,Bloco,Bloco,Bloco,Bloco,Bloco,Vazio],
